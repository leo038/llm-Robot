...
if os_name == 'Windows':
    ...
    # dllPath = os.path.join(CUR_PATH, "libRM_Base.so")  ## TODO
    dllPath = os.path.join("/home/nvidia/leo/robot/robot_sdk/custom_plugins/src/realman_plugins/realman_plugins/utils/asserts/",
                           "libRM_Base.so")
else:
